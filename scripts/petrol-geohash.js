...
var map = L.map('map').setView([37.528, -85.680],5);
...
function addFeatureLayer() {
  ...
  window.fLayer = new L.esri.FeatureLayer("http://maps.indiana.edu/ArcGIS/rest/services/Geology/Petroleum_Wells/MapServer/0", {
    style: function () {
